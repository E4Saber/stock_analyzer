  ...
  const getOption = () => {
    return {
      title: {
        ...
        top: 5,       // 增加顶部边距
        // bottom: 350,
        padding: 0,  // 添加底部内边距，增加与图表内容的距离
        textStyle: {
          fontSize: 16
        },
        subtextStyle: {
          fontSize: 12,
          // padding: [5, 0, 0, 0]  // 副标题与主标题的距离
        }
      },
      tooltip: {
        trigger: 'axis',
      ...
      xAxis: [
        {
          ...
          axisLabel: {
            ...
            hideOverlap: false, // 防止自动隐藏重叠标签
            align: 'right',     // 右对齐，有助于显示最后的标签
            interval: 'auto',    // 让ECharts自动决定显示哪些标签以避免拥挤
            showMaxLabel: true
          },
          axisTick: {
            alignWithLabel: true
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={24}>
          <Row justify="space-between" align="middle">
            ...
            <Col>
              <Space style={{ padding: '12px 0' }} size={[16, 8]}>
