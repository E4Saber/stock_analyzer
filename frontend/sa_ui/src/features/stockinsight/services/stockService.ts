...
import { StockData, ShareholderData, FinancialIndicator, MarketNews } from '../../marketoverview/types/market';
import { ChartType, IndicatorType } from '../components/widgets/config/chartConfig';

// Import mock services if in mock mode
import * as mockStockService from '../../marketoverview/services/mockStockService';
