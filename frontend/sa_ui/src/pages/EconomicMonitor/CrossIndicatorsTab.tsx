// src/pages/EconomicMonitor/CrossIndicatorsTab.tsx
...
const CrossIndicatorsTab: React.FC<RegionTabProps> = ({ onIndicatorSelect }) => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      // 过滤中美交叉指标
      const crossIndicators = dashboardData.filter(indicator => indicator.region === 'cross');
      setIndicators(crossIndicators);
      setLoading(false);
    }, 800);
  }, []);
  ...
  return (
    <div className="cross-indicators-tab">
      {/* 筛选工具栏 */}
...
export default CrossIndicatorsTab;