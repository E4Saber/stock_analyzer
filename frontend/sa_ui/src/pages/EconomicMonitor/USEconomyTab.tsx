// src/pages/EconomicMonitor/USEconomyTab.tsx
...
const USEconomyTab: React.FC<RegionTabProps> = ({ onIndicatorSelect }) => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      // 过滤美国指标
      const usIndicators = dashboardData.filter(indicator => indicator.region === 'us');
      setIndicators(usIndicators);
      setLoading(false);
    }, 800);
  }, []);
